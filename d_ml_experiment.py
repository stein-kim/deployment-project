...
def delay_model():
    ...
    parser.add_argument('--num_alphas', type=int, help='Number of Lasso penalty increments', default=20)
    order = 1
    ...
    with mlflow.start_run(experiment_id = experiment.experiment_id, run_name=run_name) as run:
        mlflow.set_tag("mlflow.runName", "data_model")
        score_min = 10000
        ...
        mlflow.sklearn.log_model(ridgereg, "model", registered_model_name="Delays")
    mlflow.end_run()
    ...
    with mlflow.start_run(experiment_id = experiment.experiment_id, run_name = "Final Model - Test Data"):
        ...
        mlflow.log_metric("Mean Squared Error",score)
        mlflow.log_metric("Average Delay",np.sqrt(score))
